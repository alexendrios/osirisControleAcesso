...
<html lang="pt-br">
    ...
    <body>
        <form class="form-horizontal" method="post" action="../service/editando.php" >
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><h2>Editar</h2></div>
                        <div class="panel-body">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="nome" name="nome" class="form-control" placeholder="Nome" aria-describedby="basic-addon1"
                                               value="<?php echo $res['nome'] ?>">
                                        <input type="text" name="id" id="id" style="display:none;" value="<?php echo $res['id'] ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control form-control-lg" id="naj" name="naj" required >
                                            <option value="<?php echo $res['naj'] ?>" selected ><?php echo $res['naj'] ?></option>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control form-control-lg" id="cargo" name="cargo" required >
                                            <option value="<?php echo $res['cargo'] ?>" selected ><?php echo $res['cargo'] ?></option>
                          ...
                          X'                  <option value="ASSESSOR" >ASSESSOR</option>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="tipoAcesso" name="tipoAcesso" class="form-control" placeholder="Tipo de Acesso" aria-describedby="basic-addon1"
                                               value="<?php echo $res['tipo_senha'] ?>" readonly/>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <div class="input-group">
                                        ...
                                        <textarea id="observacao" name="observacao" class="form-control" placeholder="Observação" aria-describedby="basic-addon1"
                                                  ><?php echo $res['observacoes'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
